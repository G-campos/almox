...
<head>
    <title>Pacman</title>
    <meta charset="utf-8" />
    <link type="text/css" rel="stylesheet" href="pcm.css"  media="screen,projection"/>
</head>
<body class="bg_color">
    <div class='container_trescolunas'>
            <!--coluna-1-->
                            <div class='coluna1'>
            ...
            <!--coluna-2-->
                            <div class='coluna2'>
                                    <a href='extra_pcm.php'>
                                        <div class='button btn2'>
                                            <img src='../../imagens/jogo.png' class='img'>
                                        </div>
                                    </a>    
                            </div>
            <!--coluna-3-->
                            <div class='coluna3'>
                               <a href='../logout.class.php'>
    ...
    <script>
        ...
        function main() {
            ...
            if (total_balls_eaten === 61) {
                win_or_lose_text.innerHTML = "You win";
            }
